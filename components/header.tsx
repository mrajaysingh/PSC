                        ...
                        <nav className="space-y-8">
                          ...
                          <div className="px-6">
                            ...
                            <div className="space-y-3 bg-muted/50 rounded-xl p-3">
                              <div className="flex items-center gap-3 p-3 text-base hover:bg-muted transition-all duration-200 rounded-lg group relative bg-background/80">
                                <Link href="/about">
                              ...
                              <div className="flex items-center gap-3 p-3 text-base hover:bg-muted transition-all duration-200 rounded-lg group relative bg-background/80">
                                <Link href="/students">
                                  ...
                                  <div className="relative z-10">
                                    <div className="font-semibold">Our Students</div>
                                    <div className="text-sm text-muted-foreground">Meet our brilliant students</div>
                                  </div>
                                  <div className="fixed left-[400px] top-1/2 -translate-y-1/2 w-[calc(70vw-2rem)] h-[80vh] rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-2xl pointer-events-none transform scale-95 group-hover:scale-100 z-[60] overflow-hidden">
                                    <img 
                                      src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&q=80&w=300&h=300" 
                                      alt="Students Preview" 
                                      className="w-full h-full object-cover rounded-2xl"
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent rounded-2xl"></div>
                                  </div>
                          ...
                          <div className="px-6">
                            ...
                            <div className="space-y-3 bg-muted/50 rounded-xl p-3">
                              ...
                              <div className="flex items-center gap-3 p-3 text-base hover:bg-muted transition-all duration-200 rounded-lg group bg-background/80">
                                <Link href="/privacy">
                                  <div className="p-2 rounded-md bg-primary/10 text-primary">
                ...
                <div className="flex-1 overflow-y-auto">
                  <nav className="flex flex-col p-4 space-y-8">
                    ...
                    <div>
                      ...
                      <div className="space-y-3 bg-muted/50 rounded-xl p-3">
                        <div className="flex items-center gap-3 p-3 text-base hover:bg-muted transition-all duration-200 rounded-lg bg-background/80">
                    ...
                    {/* Company Section */}
                    <div>
                      <h3 className="text-lg font-bold mb-4 text-foreground px-3">Coaching</h3>
                      <div className="space-y-3 bg-muted/50 rounded-xl p-3">
                        <div className="flex items-center gap-3 p-3 text-base hover:bg-muted transition-all duration-200 rounded-lg bg-background/80">
                        ...
                        <div className="flex items-center gap-3 p-3 text-base hover:bg-muted transition-all duration-200 rounded-lg bg-background/80">
                          <Link href="/instructors" onClick={() => setIsMobileMenuOpen(false)}>
                            <div className="p-2 rounded-md bg-primary/10 text-primary">
                              <GraduationCap className="h-5 w-5" />
                            </div>
                            <div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3 bg-muted/50 rounded-xl p-3">
                        ...
                        <div className="flex items-center gap-3 p-3 text-base hover:bg-muted transition-all duration-200 rounded-lg bg-background/80">
                          <Link href="/refund" onClick={() => setIsMobileMenuOpen(false)}>
                            <div className="p-2 rounded-md bg-primary/10 text-primary">
                              <RefreshCw className="h-5 w-5" />
                            </div>
                            <div>
                        ...
                        <div className="flex items-center gap-3 p-3 text-base hover:bg-muted transition-all duration-200 rounded-lg bg-background/80">
                          <Link href="/disclaimer" onClick={() => setIsMobileMenuOpen(false)}>
                            <div className="p-2 rounded-md bg-primary/10 text-primary">
                              <AlertCircle className="h-5 w-5" />
                            </div>
                            <div>
                        ...
                        <div className="flex items-center gap-3 p-3 text-base hover:bg-muted transition-all duration-200 rounded-lg bg-background/80">
                          <Link href="/code-of-conduct" onClick={() => setIsMobileMenuOpen(false)}>
                            <div className="p-2 rounded-md bg-primary/10 text-primary">
                              <UserCheck className="h-5 w-5" />
                            </div>
                            <div>
                        ...
                        <div className="flex items-center gap-3 p-3 text-base hover:bg-muted transition-all duration-200 rounded-lg bg-background/80">
                          <Link href="/copyright" onClick={() => setIsMobileMenuOpen(false)}>
                            <div className="p-2 rounded-md bg-primary/10 text-primary">
                              <Copyright className="h-5 w-5" />
                            </div>
                            <div>
